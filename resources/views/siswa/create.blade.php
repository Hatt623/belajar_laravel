        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="col-lg-12">
                        <form action="{{ route('siswa.store') }}" method="post" enctype="multipart/form-data" role="form">
                        @csrf 
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" class="form-check-input mb-3" name="jenis_kelamin" value="Laki-Laki" checked>Laki-Laki
                                </label>
                                <label class="radio-inline">
