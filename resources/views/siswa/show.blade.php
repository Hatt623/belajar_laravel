        ...
        <div id="wrapper">
            ...
            <div id="page-wrapper">
                <div class="container-fluid">
                    ...
                    <!-- /.row -->
                    <div class="col-lg-12">
                    <form action="{{ route('siswa.update' , $siswa->id) }}" method="post" enctype="multipart/form-data" role="form">
                        @csrf
                        @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <label class="radio-inline">
                                    <input type="radio" class="form-check-input mb-3" name="jenis_kelamin" value="{{ $siswa->jenis_kelamin }}" checked disabled>Laki-Laki
                                </label>
                            </div>
                            ...
                            <div class="form-group">
                                <label>Cover</label>
                                <img src="{{ asset('images/siswa/' . $siswa->cover) }}" width="100px" class=" mb-3">
                            </div>
